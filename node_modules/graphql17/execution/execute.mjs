...
export function validateExecutionArgs(args) {
    const { schema, document, rootValue, contextValue, variableValues: rawVariableValues, operationName, fieldResolver, typeResolver, subscribeFieldResolver, perEventExecutor, enableEarlyExecution, abortSignal, options, } = args;
...
function executeField(exeContext, parentType, source, fieldDetailsList, path, incrementalContext, deferMap) {
    ...
    const info = buildResolveInfo(validatedExecutionArgs, fieldDef, toNodes(fieldDetailsList), parentType, path, abortSignal);
 ...
 * @internal
 */
export function buildResolveInfo(validatedExecutionArgs, fieldDef, fieldNodes, parentType, path, abortSignal) {
...
function executeSubscription(validatedExecutionArgs) {
    ...
    const info = buildResolveInfo(validatedExecutionArgs, fieldDef, fieldNodes, rootType, path, abortSignal);
    try {
